...
import { ArrowLeft, Calendar, MapPin, Package, Tag, Phone, Mail, AlertCircle } from "lucide-react";
...
const LostItemDetail: React.FC = () => {
  ...
  const { data, isLoading, error } = useGetLostitemQuery();
  
  const lostItems: LostItem[] = data || [];
      ...
      <div className="bg-white shadow-sm">
        <div className="max-w-6xl mx-auto px-4 py-4">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            {item.status && (
              <span className={`px-3 py-1 rounded-full text-sm font-medium border ${getStatusColor(item.status)} capitalize`}>
                {item.status}
              </span>
            )}
          </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-medium">{item.category || 'Not specified'}</p>
                  </div>
                </div>
            ...
            {/* Action Buttons */}
            <div className="bg-white rounded-lg shadow-md p-6">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">Found This Item?</h2>
              <p className="text-gray-600 mb-4">
                If you have found this item or have information about it, please contact the owner using the information provided above.
              </p>
